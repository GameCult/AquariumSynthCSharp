...
public static class Dx7SysEx
{
    ...
    public const float SummedOperatorModulationRouteIndex = 6.0f;
    ...
    public static Dx7RateLevelEnvelopeApproximation ApproximateRateLevelEnvelope(Dx7Envelope envelope)
    {
        ...
        return new Dx7RateLevelEnvelopeApproximation(
            ...
            "Approximation: DX7 EG uses four rate/level segments; AquaSynth staged envelopes preserve the intermediate target levels.");
    }
        ...
        int rateScaling = 0)
    {
        ...
        return new Dx7RateLevelEnvelopeApproximation(
            new RateLevelEnvelope(
                ...
                RateLevelCurve.Exponential),
            gateSeconds,
            "Approximation: DX7 applied EG gain sampled per 64-sample block and normalized for AquaSynth operator-level scaling.");
    }
