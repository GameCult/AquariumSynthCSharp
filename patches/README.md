...
The library is intentionally outside `src/` and is not part of the shipped AquaSynth NuGet packages. Treat it as repo-owned source material for future synth consumers, examples, and parity work.
